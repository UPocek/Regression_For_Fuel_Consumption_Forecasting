...
class LassoRegression:
    __slots__ = ['learning_rate', 'iterations', 'weights', 'bias', 'loss', 'l1', 'preprocessing']

    def __init__(self, learning_rate=0.1, n_iterations=100, l1_penalty=0.1):
    ...
    def fit(self, X, y):
        ...
        for i in range(self.iterations):
            ...
            partial_w = (1 / X.shape[0]) * (2 * np.dot(X.T, (y_hat - y)) + self.l1 * np.abs(self.weights))
